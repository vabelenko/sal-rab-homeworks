...
function addInCartSumChange(sum, delta) {
    ...
    // Владимир, здравствуйте. Спасибо за присланную работу. В третьем задании следовало помимо обычного присвоения попрактиковаться с шаблонными строками.
     //Суть в том, что при использовании шаблонных строк, вы можете сразу внедрять в строку вычисляемое выражение (или константу / переменную). 
     //Запись была бы такой: newSumText = `${newSum} ₽`;. Ваше приложение необходимо развернуть с помощью github-pages. 
     //Реализуйте пожалуйста ваше приложение на github pages, чтобы всё было реализовано замечательно.
     //Поправьте пожалуйста вашу работу, чтобы всё было реализовано замечательно.
    return newSumText;
}
